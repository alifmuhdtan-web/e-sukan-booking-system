...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .form-container { background: #f0f4f8; padding: 20px; border-radius: 10px; margin-bottom: 30px; border: 1px solid #ddd; }
        ...
        .btn-edit { background: #ffc107; color: #333; padding: 5px 10px; text-decoration: none; border-radius: 5px; display: inline-block; }
        .btn-delete { background: #dc3545; color: white; padding: 5px 10px; text-decoration: none; border-radius: 5px; display: inline-block; }
    ...
    <div class="container">
        ...
        <div class="form-container">
            ...
            <form action="${pageContext.request.contextPath}/manager/facilities" method="post">
                ...
                <% if (isEdit != null && isEdit) { %>
                    <a href="${pageContext.request.contextPath}/manager/facilities" class="btn-cancel">Cancel</a>
                <% } %>
            </form>
        </div>
